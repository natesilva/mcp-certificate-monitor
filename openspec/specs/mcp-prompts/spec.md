...
Defines requirements for the MCP Prompts exposed by the certificate monitor server. Covers the audit prompt for analyzing certificate expiry across all monitored hosts and the renewal planning prompt for a specific domain.
