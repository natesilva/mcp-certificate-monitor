...
Defines requirements for the FastMCP server layer that exposes certificate monitoring capabilities to an AI host. Covers the server instance, risk classification constants, and the five registered tools for live certificate checking and host management.
